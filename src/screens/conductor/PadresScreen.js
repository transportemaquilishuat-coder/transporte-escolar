...
export default function ConductorPadresScreen() {
  ...
  const handleVincularDirecto = async () => {
    try {
      ...
      setNuevoPadre({ nombre: '', email: '', password: '', telefono: '', dui: '', rutaId: '' });
      await cargarPadres();
    ...
    <View style={styles.container}>
      <View style={styles.hero}>
        ...
        <Text style={styles.heroSubtitle}>
          El conductor crea codigos para los padres y tambien puede vincularlos manualmente.
        </Text>
      </View>
      ...
      <Modal visible={modalDirecto} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TextInput style={styles.input} placeholder="ID de ruta" keyboardType="numeric" value={nuevoPadre.rutaId} onChangeText={(t) => setNuevoPadre({ ...nuevoPadre, rutaId: t })} placeholderTextColor={KIDGO_THEME.textSecondary} />
